...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Productos Comparaonline</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="editar_registro" method="post">
                                        <input type="hidden" name="username" value="<?=$p->id?>" />
...
<div class="col-md-4 col-md-offset-10">
    <a href="crear_usuario" class="btn btn-outline btn-primary" role="button">Agregar Producto
    </a>
  </div>
                            <!-- /.table-responsive -->
                            <div class="col-md-4 col-md-offset-10">
